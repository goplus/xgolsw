...
func (id BackdropResourceID) URI() ResourceURI {
	return ResourceURI(fmt.Sprintf("%s/%s", id.ContextURI(), url.PathEscape(id.BackdropName)))
}
...
func (id SpriteResourceID) URI() ResourceURI {
	return ResourceURI(fmt.Sprintf("%s/%s", id.ContextURI(), url.PathEscape(id.SpriteName)))
}
...
func (id SpriteCostumeResourceID) URI() ResourceURI {
	return ResourceURI(fmt.Sprintf("%s/%s", id.ContextURI(), url.PathEscape(id.CostumeName)))
}
...
func FormatSpriteCostumeResourceContextURI(spriteName string) ResourceContextURI {
	return ResourceContextURI(fmt.Sprintf("%s/%s/costumes", SpriteResourceContextURI, url.PathEscape(spriteName)))
}
...
func (id SpriteAnimationResourceID) URI() ResourceURI {
	return ResourceURI(fmt.Sprintf("%s/%s", id.ContextURI(), url.PathEscape(id.AnimationName)))
}
...
func FormatSpriteAnimationResourceContextURI(spriteName string) ResourceContextURI {
	return ResourceContextURI(fmt.Sprintf("%s/%s/animations", SpriteResourceContextURI, url.PathEscape(spriteName)))
}
...
func (id SoundResourceID) URI() ResourceURI {
	return ResourceURI(fmt.Sprintf("%s/%s", id.ContextURI(), url.PathEscape(id.SoundName)))
}
...
func (id WidgetResourceID) URI() ResourceURI {
	return ResourceURI(fmt.Sprintf("%s/%s", id.ContextURI(), url.PathEscape(id.WidgetName)))
}
