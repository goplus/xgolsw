...
func spxDiagnosticPass(proj *xgo.Project, result *spxAnalysis) func(string, *protocol.Pass) {
	ctx := &definitionContext{proj: proj, framework: result.spxSymbols, frameworkResolved: true}
