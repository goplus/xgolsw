...
func (s *Server) inspectForSpxResourceRefs(result *compileResult) {
	s.collectSpxSpriteResourceAutoBindings(result)
	s.inspectForSpxResourceRefsFromClassfileInfo(result, ".spx")
}

// collectSpxSpriteResourceAutoBindings collects auto-bound sprite resources.
func (s *Server) collectSpxSpriteResourceAutoBindings(result *compileResult) {
